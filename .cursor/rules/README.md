...
- **`bibliography.mdc`** — Applies to `bibliography/**` and `references.bib`. Points at bib-mcp; BUS-658 paths and “Relevance to our class”.
- **`references.mdc`** — Applies to `references.bib` and bibliography notes. Points at bib-mcp; `references.bib` at root.
