...
- Work collaboratively to statistically analyze empirical questions about or propose innovative solutions to challenges around AI and digital technologies, and build a project portfolio
...
- 20% Student discussion questions or other weekly assignment
    - The day before class, students will be required to submit 1 question based on the scheduled reading These will be graded rigorously based on the knowledge students will have access to LLMs and the internet (and encouraged to use them!) when generating them. 
...
- 30% Final Project
    ...
    - We will encourage students to form teams of two to work on these projects, although they will be allowed to work individually. Grading will take into account the size of the team, but grading rigor will scale sub-linearly in group size to encourage groups. 
    - We encourage you to continue developing a portfolio project as your final project.
...
- Unit 1 - Artificial Intelligence: 
    ...
    - Week 3, 4, 5: Will Automation Save or Doom the Economy? Readings on AI, alignment, and economic issues.
...
This needs to be done before the deadline. No extension for the final project presentations.


## Participation

It is expected that students attend every lecture. Let us now if you have a religious or medical issue.
