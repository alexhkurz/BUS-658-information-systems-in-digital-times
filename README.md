...
<span style="color: #888;">Slides are written in [Marp](https://marp.app/) markdown in `slides/`. For example, to deploy [`slides/slides01.md`](slides/slides01.md) to [GitHub Pages](https://alexhkurz.github.io/BUS-658-information-systems-in-digital-times/slides/slides01.html) run `bash scripts/gh-pages.sh`.</span> 